...
def RFID_stop():
    ...
    result = client.write_registers(address=register_address+0x32, values=stop_command[:], slave=1)
...
def RFID_write():
    ...
    if data_write == "\n":
        ...
        result_write = client.write_registers(address=register_address+0x32, values=write_command[:], slave=1)  # 
...
def RFID_read():
    ...
    result1 = client.write_registers(address=register_address+0x32, values=read_command[:], slave=1)
    print(result1)
